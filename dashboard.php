...
<html lang="en">
    ...
    <body class="top-navbar-fixed" style="background-color:Cadetblue;" >
                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-sm-6">
                                    <h2 class="title" style="padding-left:500px;"><u>DASHBOARD</h2>
...
?>
                                    ...
                                    <!-- /.col-lg-6 col-md-3 col-sm-6 col-xs-12 -->

                                    <div class="col-lg-6 col-md-3 col-sm-6 col-xs-12" style="padding-top:10px;">
