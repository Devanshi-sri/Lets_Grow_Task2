...
<html lang="en">
    ...
    <body class="">
        <div class="main-wrapper">
            ...
            <div class="login-bg-color bg-black-300" style="background-color:DarkCyan;">
                <div class="row" >
                    <div class="col-md-4 col-md-offset-4">
                        <div class="panel login-box">
                            <div class="panel-heading">
                                <div class="panel-title text-center">
                                    <h4><u>School Result Management System</u></h4>
                                </div>
                            </div>
...
<?php }} ?>
                                    ...
                                    <div class="form-group mt-20">
                                        ...
                                        <button type="submit" name="login" class="btn btn-success btn-lg btn-labeled pull-right">Search</button>
