...
<html lang="en">
    <head>
        ...
        <title>IMS Admin Create Class</title>
...
.succWrap{
    ...
    <body class="top-navbar-fixed"  style="background-color:Silver;">
...
<div class="alert alert-success left-icon-alert" role="alert">
 <strong>Well done!</strong><?php echo htmlentities($msg); ?>
  ...
  <div class="form-group has-success">
                                                        ...
                                                        <div class="">
                                                           <button type="submit" name="submit" class="btn btn-success btn-lg btn-labeled pull-right">Submit<span class="btn-label btn-label-right"><i class="fa fa-check"></i></span></button>
                                                    </div>
